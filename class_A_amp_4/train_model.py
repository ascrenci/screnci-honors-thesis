...
import torch
import numpy as np
from model_classes import build_datasets, ClassAModel
...
train_dataset, val_dataset = build_datasets(data_file)
...
torch.save(model.state_dict(), f"{branch}/class_a_model_4_{n_datapoints}.pth")